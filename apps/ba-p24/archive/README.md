This is a [Next.js](https://nextjs.org/) server only project that helps sync listings from [PropCntrl](https://online.propctrl.com/) to [BA Real Estates'](https://www.barealestates.co.za/) website.
