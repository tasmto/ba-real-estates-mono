    ...
    <footer className="bg-gray-800" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center gap-1">
              <Image
                ...
                width={57}
              />
              <h1 className="text-xl font-semibold tracking-tighter text-gray-100">
                BA Real Estates
              </h1>
            </div>
              ...
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {propertyCategories?.map((cat, i) => (
                    <FooterLink
                      key={cat?.name ?? i}
                      href={`/listings/${i}?category=${cat.slug?.current}`}
                    >
                      {cat.name}
                    </FooterLink>
                  ))}
          ...
          <div className="col-span-full mt-12 border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-200">
                Subscribe to our newsletter
              </h3>
              <p className="mt-2 text-base text-gray-500">
                Sign up to get news and updates from us as well as the latest
                trends and hot tips in Real Estate.
              </p>
            </div>
            <NewsletterForm className="mt-4 sm:flex sm:max-w-md lg:mt-0" />
          </div>
          <div className="col-span-full mt-4 border-t border-gray-700 pt-8">
