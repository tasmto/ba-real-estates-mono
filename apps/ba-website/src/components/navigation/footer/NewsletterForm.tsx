                ...
                <fieldset className={`${className}`}>
                    ...
                    <div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                        <button disabled={isLoading}
                            type='submit'
                            className='flex w-full items-center justify-center rounded-md border border-transparent bg-primary-600 py-2 px-4 text-base text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:bg-gray-600'
                        >
                            Subscribe
                        </button>
                    </div>
