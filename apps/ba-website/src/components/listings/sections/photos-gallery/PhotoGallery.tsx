...
const PhotoGallery = ({ images, property }: Props) => {
    ...
    return (
        <div
            className="grid h-96 grid-rows-3 gap-3 sm:h-[30rem] sm:grid-cols-5 sm:grid-rows-1 relative"
                ...
                {images.slice(1).map((image, i, arr) => (
                    ...
                    >
                        <Image
                            ...
                            alt={""}
                            className="h-full !w-24 sm:!w-full object-cover object-center"
                        />
                    </div>
                ))}
            </div>
                    ...
                    >
                        <div className="my-8 inline-block min-h-[50vh] sm:h-[90vh] max-h-[600px] w-screen max-w-[88vw] translate-y-1/4 transform divide-y-2 divide-gray-200 overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all sm:max-h-[800px] sm:w-[95vh] lg:max-w-[80vw]">
                            ...
                            <div className="h-auto sm:h-[96%]">
                                {activeTab === "photos" && (
                                    <div className="grid h-full grid-rows-[1fr_150px] gap-3 px-6 sm:grid-cols-3 sm:grid-rows-1 sm:gap-6">

                                        <div
                                            className={clsx([
                                                "sm:!w-auto order-2 flex gap-2 overflow-auto  sm:order-first sm:col-span-1 sm:mb-8 sm:mt-4 sm:flex-col sm:pr-4",
                                            ])}
                                        ...
                                        >
                                            {images.map((image, index) => (
                                                <button
                                                    key={image._key}
                                                    type="button"
                                                    className={clsx([index === activeImageIndex
                                                        ? "outline-4 outline -outline-offset-4 outline-gray-800"
                                                        : "",
                                                ...
                                                >
                                                    <Image
                                                        ...
                                                        alt=""
                                                        className={clsx(["min-w-[150px] h-full sm:h-auto sm:min-w-full sm:w-full overflow-hidden rounded-lg sm:object-contain md:m-auto object-cover",])}
                                                    />
                                                </button>
                                            ))}
                                        </div>
                                        <div className="relative flex h-full w-full items-center overflow-hidden py-4  sm:col-span-2">
                                ...
                                {activeTab === "map" && (
                                    <div className="col-span-full h-[95%] px-6 sm:h-full w-full py-4">
