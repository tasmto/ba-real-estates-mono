...
interface PropertyType extends Omit<Property, 'location' | 'agents' | 'features'> {
    location: Area;
...
const ListingPageContactForm = ({ property }: Props) => {
    ...
    const processForm = async (data: FieldValues) => {
        ...
        try {
            const req = await fetch(
                'https://formeezy.com/api/v1/forms/63d9f462326630008f16dd1/submissions',
                {
                    method: 'POST',
                    body: JSON.stringify({
                        ...data,
            ...
            {loading ? (
                ...
                <div className='grid h-full items-start rounded-lg border border-slate-200 py-6 px-4'>
                    ...
                    <p className='text-lg text-gray-500'>
                        ...
                        possible.
                        <br /><br /> For now feel free to explore the rest of our website for any
                        more properties you might be interested in
                    </p>
                    <Link
                        href='/listings'
                        type='button'
                    ...
                    >
                        <span>Explore our Other Listings</span>
                        <HiArrowRight />
                    </Link>
                </div>
            ) : (
...
export default ListingPageContactForm;
