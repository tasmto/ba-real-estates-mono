...
import { useFetchListings, useFetchPropertyCategories } from '@/hooks/useSanity';
...
const HomePage = async (props: Props) => {
  const allPropertyCategories = await useFetchPropertyCategories<PropertyCategory>()
  ...
  return (
    <div>
      <div className="  bg-gradient-to-b from-slate-800/60 via-slate-800/10 to-slate-800/0 relative overflow-hidden">
        <div className='absolute h-full w-full top-0 left-0 -z-10 bg-[#021d2b]' >
          <Image width={900} height={500} src="https://images.unsplash.com/photo-1575517111478-7f6afd0973db?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" className='cover h-full w-full object-cover blur-xl scale-110' />
        </div>
        <div className="relative overflow-hidden">
          <div className="absolute inset-y-0 h-full w-full" aria-hidden="true">
            <div className="relative h-full">
              ...
              <svg
                className="absolute left-full transform -translate-y-3/4 -translate-x-1/4 sm:-translate-x-1/2 md:translate-y-[-30%]   lg:-translate-x-3/4"
                width={404}
                height={784}
                fill="none"
                viewBox="0 0 404 784"
              >
                <defs>
                  ...
                  >
                    <rect x={0} y={0} width={4} height={4} className="text-gray-200/10" fill="currentColor" />
                  </pattern>
                </defs>
          ...
          <div className="relative pt-6 pb-16 sm:pb-24">
            ...
            <div className="mt-14 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
              <div className="text-center md:text-start md:grid md:grid-cols-2 gap-2 lg:gap-10">
                <h1 className="font-display tracking-tight font-bold text-gray-100 lg:text-[3.5rem] text-5xl">
                  <span className="text-yellow-500 drop-shadow-sm block">Beyond Architecture</span> Real Estates.

                </h1>
                <p className="mt-3 max-w-md mx-auto text-base text-gray-50 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                  Our full-service, streamlined approach provides educating the client the process of acquiring real estates, prequalification and exceptional value.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-800">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <h2 className="text-center text-gray-400 text-sm font-semibold uppercase tracking-wide">
              Here are some of our forward-thinking partners
            </h2>
            <div className="mt-8 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image
                  ...
                  src='/images/assets/vtc-logo.png'
                  alt=''
                />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
